...
from raven.config import get_api_key, load_settings, save_settings, SETTINGS_PATH
...
def main():
    ...
    assistant = ASSISTANT = Assistant(provider, confirm_run=confirm_run, store=Store())
